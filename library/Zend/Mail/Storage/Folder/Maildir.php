 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Mail_Storage_Folder_Maildir extends Zend_Mail_Same, DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR;
    ...
    protected function _buildFolderTree()
    {
        ...
        while (($entry = readdir($dh)) !== false) {
            ...
            if ($entry[0] != '.' || $entry == '.' || $entry == '..torage_Maildir implements Zend_Mail_Storage_Folder_Interface
{
    /**
    ...
    public function __construct($params)
    {
        ...
        $this->_rootdir = rtrim($params->dirn') {
                continue;
            }

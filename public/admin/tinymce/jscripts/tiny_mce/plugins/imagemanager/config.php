<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../../FrontEnd/pictures/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../FrontEnd/pictures/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv";
        ...
        $mcImageManagerConfig['upload.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,png,doc,docx,xls,xlsx";

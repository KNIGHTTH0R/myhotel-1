...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Trang đầu",sLast:"Trang cuối",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ to _END_ of _TOTAL_ dòng",sInfoEmpty:"Hiển thị 0 to 0 of 0 dòng",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Hiển thị _MENU_ dòng",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sUrl:"",sZeroRecords:"No matching records found"},

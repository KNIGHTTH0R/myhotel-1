...
class Iadm_HotelRoomFacilitiesController extends MyZend_Controller_AdminAction {
	...
	public function init() {
		...
		parent::init();
		$this->Model = new Iadm_Model_HotelRoomFacilities();
	...
	public function editAction() {
		...
		if ($this->getRequest()->isPost()) {
			...
			if (count($this->ErrorMsg) == 0) {
				...
				$this->forward('index', 'hotel-room-facilities', 'iadm', array(
	...
	public function deleteAction() {
		...
		$this->forward('index', 'hotel-room-facilities', 'iadm', array('page' => $this->SessionPage->currentPageNumber));
	}
